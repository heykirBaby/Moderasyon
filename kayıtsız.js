...
if(!['825831729385308171'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
await member.roles.add('825831748867850312')//kayıtsız rol id yaz
.setTitle(' ✔️ Kayıtsıza Atılma İşlemi Başarıyla Tamamlandı')
